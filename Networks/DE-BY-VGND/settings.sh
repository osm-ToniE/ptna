...
NETWORK_LONG="Verkehrsgmeinschaft Neuburg an der Donau|Ingolstädter Verkehrsgesellschaft mbH|Regionalbus Augsburg|Seitz|Spangler|Stadtbus Schrobenhausen|Stadtlinie Neuburg|Werksbus MBB"
