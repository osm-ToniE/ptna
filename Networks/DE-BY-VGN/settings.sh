...
ANALYSIS_OPTIONS="--max-error=10 --check-sequence --check-access --check-name --check-stop-position --check-version --check-osm-separator --multiple-ref-type-entries=analyze --positive-notes --coloured-sketchline"
